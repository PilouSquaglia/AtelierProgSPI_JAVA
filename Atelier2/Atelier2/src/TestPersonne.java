...
public class TestPersonne {
	...
	public static void main(String[] args) {
		...
		Adresse adresse=new Adresse(9,"Lot Belle �le en mer","20620","Biguglia");
		Adresse adresse2=new Adresse(8,"Lot Test","20600","Bastia");
		//Personne P1 = new Personne("SQUAGLIA", "Pilou", 14, 11, 2001,9,"Lot Belle �le en mer", "20620", "Biguglia");
		...
		//System.out.println("Nombre d'ann�es pass� dans l'entreprise : "+e1.calculAnnuite());
